...
public class RegiResztvevok {
    String szakmaiVezeto;
    String projektmenedzser;
    String kezelo;
    ArrayList<String> resztvevoEmberek;

    public RegiResztvevok(String szakmaiVezeto, String projektmenedzser, String kezelo, ArrayList<String> resztvevoEmberek) {
